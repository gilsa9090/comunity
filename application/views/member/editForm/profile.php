...
<form action="<?= base_url('profile/updateMember'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row justify-content-end">
            <div class="col-sm-10">
                ...
                <a href="<?= base_url('profile/memberEdit'); ?>"><button type="button" class="btn btn-primary">Kembali</button></a>
            </div>
        </div>
</form>
</div>