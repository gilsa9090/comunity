...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <nav>
        <ul>
        <span class="mr-2 d-none d-lg-inline small" style="color: #c43552;"><?= $user['nama']; ?></span>
        <img class="img-profile rounded-circle"src="<?php echo base_url('assets/image/').$user['image']; ?>" width="40px" height="40px">
        </ul>
      </nav>
    </div>
    ...
    <div id="content" class="content">
        ...
        <a href="<?= base_url('member') ?>" class="btn mt-3">Dashboard</a>
